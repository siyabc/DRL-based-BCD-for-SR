...
# with all features, including previous features (G,v,w...) and new features in rewardv3_v2 but without til_gamma of iterations.
...
def step(o, a, label):
    ...
    # o2 = np.append(o[:-3], notil_gamma)
    o2 = np.hstack((o[:16], Fpv.reshape(3), rate.reshape(3), notil_gamma.reshape(3)))
