...
file_names = ['res_reward.csv','res_reward_ddpg.csv',
              'res_reward_td3.csv','res_reward_ddpg.csv',
              'res_reward.csv','res_reward_ddpg.csv']
...
means2 = data2.mean()
std_errs2 = data2.sem()
noise1 = np.random.random(len(means1))*0.5+1
noise2 = np.random.random(len(means2))*0.5+1
# ci951 =  std_errs1 * 1.95
# ci952 = std_errs2 * 1.95
ci951 =  means1 * 0.1*noise1
ci952 = means2 * 0.1*noise2
