...
xticklabels = [[r"$1\!\!\times\!\! 10^{\!\!-\!\!4}$", r"$5\!\!\times\!\! 10^{\!\!-\!\!5}$", r"$1\!\!\times\!\!10^{\!\!-\!\!5}$",r"$1\!\!\times \!\!10^{\!\!-\!\!6}$",r"$1\!\!\times \!\!10^{\!\!-\!\!7}$"],
               ['0.80','0.85','0.90','0.95','0.99'],
               [2500,3500,4500,5500,6500],
               [10, 20, 30,40,50]]
ylim = [(-0.05, 0.4),(-0.05, 0.4),(-0.05, 0.4),(-0.05, 0.4)]
mean = {
...
for i in range(num_fig):  # 修改这里
    ...
    fig, ax = plt.subplots(figsize=(7.1, 7.1))  # 创建单个子图
    ...
    for j in range(len(mean[param[i]])):
        ...
        ax.errorbar(x_positions, means, yerr=ci952, capsize=0, linestyle='None',
                    marker=mark_type[j], elinewidth=2, ecolor=ecolor[j], color=color[j], alpha=.7)
